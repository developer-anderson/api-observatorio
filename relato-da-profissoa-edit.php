...
if (isset($_POST['new_material'])) {
    ...
    if(isset($_FILES["arquivo"]) and !empty($_FILES["arquivo"]['name']))
    {
        ...
        $sql .= ", arquivo = '".$dir."'  where id_relato =".$_POST['id_relato'];
        $db->query($sql);
    ...
    if(isset($_GET['id_relato']))
    {
        $sql .= " and id_relato = ".$_GET['id_relato'];
    }
            ...
            <div class="row page-container">
                ...
                <div class="col-sm-12">
                    ...
                    <form class="dados-material-didatico w-100" method="post" enctype="multipart/form-data" id="materialDidatico">
                        ...
                        <input type="hidden" name="id_relato" value="<?php echo($_GET['id_relato']); ?>" />
